  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        // Ensure session is available quickly after sign-in to avoid stuck-at-login race.
        try {
          await withTimeout(supabase.auth.getSession() as any, 5000, 'login:getSessionAfterSignIn');
        } catch {}
