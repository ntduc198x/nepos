...
export const LockScreen: React.FC = () => {
  ...
  const [errorReason, setErrorReason] = useState<'INVALID_PIN' | 'IDENTITY_MISMATCH' | 'NOT_ALLOWED_FOR_ROLE' | null>(null);
  ...
  const handleUnlock = async () => {
    ...
    try {
      ...
      if (result.ok) {
        ...
        setIsError(true);
        setErrorReason(result.reason || 'INVALID_PIN');
